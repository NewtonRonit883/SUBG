...
detail_surf3 = text_font1.render('HIMALAYAS',False,'#DD05FA')
test_surface, detail_surf = test_surface1, detail_surf1
detail_brect = detail_surf.get_rect(center= (500,250))

restart = pygame.image.load('OP/restart.JPG')
quit = pygame.image.load('OP/restart.JPG')
restart_rec = restart.get_rect(center = (300,400))
...
while True:
    ...
    for event2 in pygame.event.get():
        if event2.type == pygame.QUIT:
            ...
            elif player_rect.collidepoint(event2.pos):
                play = True
            ...
            if event2.key == pygame.K_SPACE:
                ...
                while main:
                    ...
                    coin_count = text_font.render(':' + str(coin), False,'#140779')
                    coin_coint_rect = coin_count.get_rect(center = (100,75))
